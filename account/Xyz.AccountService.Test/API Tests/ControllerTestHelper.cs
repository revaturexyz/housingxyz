...
//Local Projects
using Xyz.AccountService.Api;
using Xyz.AccountService.Api.Controllers;
using Xyz.AccountService.Lib;
...
namespace Xyz.AccountService.Test
{
    public class ControllerTestHelper
    {

        public Mock<Xyz.AccountService.Lib.Interface.IGenericRepository> IRepository { get; private set; }
